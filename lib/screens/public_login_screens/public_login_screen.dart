import 'package:bhooskhalan/screens/public_login_screens/public_login_controller.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              ...
              child: TextButton(
                onPressed: () {
                  Get.snackbar('Info', 'Forgot password functionality not implemented');
                },
                child: const Text(
                  'Forgot password?',
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.snackbar("Info", "Registration screen not implemented yet.");
                  },
                  child: const Text(
                    'Register now',
                    style: TextStyle(
