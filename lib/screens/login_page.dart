import 'package:bhooskhalan/screens/dialog_box.dart';
import 'package:bhooskhalan/screens/language_dialog.dart';
import 'package:bhooskhalan/screens/register_form.dart';
  ...
  physics: NeverScrollableScrollPhysics(),
   child: Column(
    ...
    children: [
      ...
      Image.asset('assets/logo.png', height: 150,width: 400,),  // const SizedBox(height: 20), // optional: add slight spacing between logo and text
      Row(
        mainAxisSize: MainAxisSize.min,
       ...
       child: Column(
        ...
        SizedBox(
          ...
          child: ElevatedButton(
           onPressed: () => showLoginAsDialog(context),
